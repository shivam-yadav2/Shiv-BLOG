          ...
          <div className="max-w-md mx-auto text-white">
            <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <input className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bg-gray-800 text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500" type="text" id="fullname" />
              </div>
              <div>
                <label className="font-semibold text-sm text-gray-400 pb-1 block" htmlFor="email">Email</label>
                <input className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bg-gray-800 text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500" type="email" id="email" />
              </div>
              <div>
            ...
            <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <input className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full bg-gray-800 text-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500" type="date" id="dob" />
              </div>
              <div>
            ...
            <div className="flex items-center justify-between mt-4">
              ...
              <NavLink to='/login' className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline" >have an account? Log in{/*
        */}
                <span className="w-1/5 border-b dark:border-gray-600 md:w-1/4" />
              </NavLink></div>
          </div>
